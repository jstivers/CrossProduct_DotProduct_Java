...
public class CrossProduct_DotProduct{
    ...
    public  static void DecisionFunction(){
        ...
        if (choice.equals("Quit")){
        ...
        else if (choice.equals("Cross Product")){
            ...
            Double[] CrossProductResult = (CrossProduct(container1,container2));
            System.out.println(CrossProductResult);
        }
        else if (choice.equals("Dot Product")){
            System.exit(0);
        }
    }
    public static Double[] CrossProduct(String container1 , String container2){
